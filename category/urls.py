...
urlpatterns = [
    ...
    path('admin/sub/list/', subcategory_views.get_admin_subcategory_view, name='adminGetCategories'),
    path('sub/add/', subcategory_views.add_subcategory_view, name='addSubcategory'),
    path('sub/update/', subcategory_views.update_subcategory_view, name='updateSubcategory'),
    path('sub/delete/',subcategory_views.delete_subcategory_view, name='deleteSubcategory'),
